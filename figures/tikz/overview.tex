...
\begin{tikzpicture}[
	...
	\node[above left=0.5cm and 3cm of madgraph] (paramcard) {\texttt{Param Card}}
	edge [->, line width=1.0pt] node[auto] {} (madgraph);
	\node[below=1cm of paramcard] (runcard) {\texttt{Run Card}}
	edge [->, line width=1.0pt] node[auto] {} (madgraph);
	...
	\begin{scope}[on background layer]
		\node [label={below:User Configuration}, minimum width=4cm, inner sep=0.5cm, boxit=green, fit=(paramcard) (runcard) (proccard) (pythiacard) (delphescard)] {};
