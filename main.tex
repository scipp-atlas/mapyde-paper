...
\setminted[toml]{fontsize=\scriptsize, numbersep=5pt, frame=lines, framesep=2mm, gobble=0}
\setminted[ini]{fontsize=\scriptsize, numbersep=5pt, frame=lines, framesep=2mm, gobble=0}
...
\newcommand{\easyscanhep}{\texttt{EasyScan\_HEP}}
...
\section{EasyScan Configuration}
\label{sec:easyscan-configuration}
