...
This paper describes the implementation of, and results obtained with, version \texttt{v0.5.0} of \mapyde.  This package can be installed via \texttt{pip}~\cite{pypi} or \texttt{conda}~\cite{anaconda}, as shown in~\Cref{lst:install}. The \mapyde{} package provides support for using the following tools:
